...
<form method="POST" action="tipo_atualizar.php">
    ...
    <select id="controla_espacos" name="controla_espacos" required>
        <option value="N" <?= $tipo["CONTROLA_ESPACOS"] == "N" ? "selected" : "" ?>>Não</option>
        <option value="S" <?= $tipo["CONTROLA_ESPACOS"] == "S" ? "selected" : "" ?>>Sim</option>
    </select>
